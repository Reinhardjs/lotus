            ...
            <div class="row mb-4 ml-5">
                ...
                <div class="col-sm-5">
                    <!-- <ol class="float-sm-right">
                        <a href="<?= url('/kinerja/analisis_iku/' . "$main/create") ?>" type="button" class="btn btn-primary"> Tambah <i class="fas fa-plus"></i></a>
                    </ol> -->
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="row">
                <?php foreach ($rows as $row) : ?>
                    <div class="col-6 col-md-3 mb-4 text-center">
                        <div class="knob-label"><b><a href='<?= url('/kinerja/analisis_iku/' . $row->main . '/' . $row->sub . '/update') ?>'><?= $row->nama_iku ?></b></a>
                        </div>
