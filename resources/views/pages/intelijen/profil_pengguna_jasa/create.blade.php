                  ...
                  <div class="row">
                    <div class="col-md-10">
                      <div class="form-group">
                        ...
                        <input type="text" id="nama_importir" name="nama_importir" class="form-control">
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" id="penanggungjawab_perusahaan" name="penanggungjawab_perusahaan" class="form-control">
                      </div>

                      <div class="form-group">
                        <label for="riwayat_pemberitahuan_pabean">Riwayat Pemberitahuan Pabean</label>
                        <input type="text" id="riwayat_pemberitahuan_pabean" name="riwayat_pemberitahuan_pabean" class="form-control">
                      </div>
                    </div>
                  </div>
                  <form>
